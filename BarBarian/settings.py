"""
Django settings for BarBarian project.
...
SECRET_KEY = '0f9_x!xovi&8e2hr92hlf0#_9@r$=p%g56c!+*d7tn)29sr)ca'
...
WSGI_APPLICATION = 'BarBarian.wsgi.application'
